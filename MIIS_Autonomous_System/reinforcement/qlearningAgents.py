...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        self.values = util.Counter() #state - action tuple
    ...
    def computeValueFromQValues(self, state):
        ...
        """
        # Get legal actions in the current state and get its QValues
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        #Formula to update is
        # Q(ai,si) = (1-alpha)* Q(ai,si) + alpha * (reward_i+1 + discount * max(Q(a,s_i+1)
