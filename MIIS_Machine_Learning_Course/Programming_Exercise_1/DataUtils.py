...
class DataUtils:
    ...
    def update_linear_error(self,y_train, pred):
        self.error.append(mean_squared_error(y_train, pred))

    def update_logistic_error(self, y_train, pred):
        self.error.append(accuracy_score(y_train, pred))
